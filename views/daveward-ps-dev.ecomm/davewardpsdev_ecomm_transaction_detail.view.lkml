...
# The name of this view in Looker is "Davewardpsdev Ecomm Transaction Detail"
view: davewardpsdev_ecomm_transaction_detail {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `daveward-ps-dev.ecomm.transaction_detail` ;;
